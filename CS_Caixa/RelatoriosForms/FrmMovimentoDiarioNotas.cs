...
{
    public partial class FrmMovimentoDiarioNotas : Form
    {

        DateTime dataInicio;
        DateTime dataFim;
        public FrmMovimentoDiarioNotas(DateTime dataInicio, DateTime dataFim)
        {
        ...
        private void FrmMovimentoDiarioNotas_Load(object sender, EventArgs e)
        {
            ...
            this.atoTableAdapter.FillByMovimentoDiarioNotas(this.cS_CAIXA_DBDataSet.Ato, dataInicio, dataFim);
