...
{
    public partial class FrmControleDiarioEscritura : Form
    {
        DateTime dataInicio;
        DateTime dataFim;
        Usuario _usuario;
        public FrmControleDiarioEscritura(DateTime dataInicio, DateTime dataFim, Usuario usuario)
        {
        ...
        private void FrmControleDiarioEscritura_Load(object sender, EventArgs e)
        {
