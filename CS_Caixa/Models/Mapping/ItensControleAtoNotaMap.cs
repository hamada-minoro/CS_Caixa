...
{
    public class ItensControleAtoNotaMap : EntityTypeConfiguration<ItensControleAtoNota>
    {
        public ItensControleAtoNotaMap()
        {
            // Primary Key
            this.HasKey(t => t.Id_ControleAtoNotas);
            ...
            this.ToTable("ItensControleAtoNotas");
            this.Property(t => t.Id_ControleAtoNotas).HasColumnName("Id_ControleAtoNotas");
            ...
            this.HasRequired(t => t.ControleAto)
                .WithMany(t => t.ItensControleAtoNotas)
