...
{
    public class ItensCustasControleAtosProtestoMap : EntityTypeConfiguration<ItensCustasControleAtosProtesto>
    {
        public ItensCustasControleAtosProtestoMap()
        {
            // Primary Key
            ...
            this.HasRequired(t => t.ControleAto)
                .WithMany(t => t.ItensCustasControleAtosProtestoes)
