...
{
    public class ItensCustasProtestoMap : EntityTypeConfiguration<ItensCustasProtesto>
    {
        public ItensCustasProtestoMap()
        {
            // Primary Key
            ...
            this.ToTable("ItensCustasProtesto");
            ...
            this.HasRequired(t => t.Ato)
                .WithMany(t => t.ItensCustasProtestoes)
