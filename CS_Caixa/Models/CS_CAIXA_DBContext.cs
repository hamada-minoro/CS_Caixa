...
namespace CS_Caixa.Models
{
    public partial class CS_CAIXA_DBContext : DbContext
    {
        ...
        public DbSet<ReciboNota> ReciboNotas { get; set; }
        public DbSet<Recolhimento> Recolhimentoes { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new ParteMap());
            ...
            modelBuilder.Configurations.Add(new ReciboNotaMap());
            modelBuilder.Configurations.Add(new RecolhimentoMap());
